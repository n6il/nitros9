...
#define E_DCD       0x80 /* Data Carrier Detect, new code from ACIAPAK patch *

/* window errors */
#define E_IWNTYP    0xb7 /* Illegal window type */
#define E_WNDEF     0xb8 /* Window already defined */
#define E_FNTNFD    0xb9 /* Font not found */
#define E_STKOVF    0xba /* Stack overflow */
#define E_ILLARG    0xbb /* Illegal argument */
#define E_ILCOOR    0xbd /* Illegal coordinates */
#define E_INTGCK    0xbe /* Internal integrity check */
#define E_BUFSML    0xbf /* Buffer size too small */
#define E_ILLCMD    0xc0 /* Illegal command */
#define E_WINFUL    0xc1 /* Screen or window table full */
#define E_BADBUF    0xc2 /* Bad/undefined buffer number */
#define E_ILWNDF    0xc3 /* Illegal window definition */
...
#define ERANGE  45      /* overflow on coverseion of ASCII to long integer */
